...
class EditarProductos extends StatefulWidget {
  const EditarProductos({Key key}) : super(key: key);
...
class _EditarProductosState extends State<EditarProductos> {
  ...
  TextEditingController controlNombre = TextEditingController(text: nombreprod);
  TextEditingController controlPrecio = TextEditingController(text: precioprod);
