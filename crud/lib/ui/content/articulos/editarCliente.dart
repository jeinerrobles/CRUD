...
class EditarClientes extends StatefulWidget {
  ...
  @override
  State<EditarClientes> createState() => _EditarClientesState();
}
...
class _EditarClientesState extends State<EditarClientes> {
  TextEditingController controlIdCliente = TextEditingController(text: idcli);
  TextEditingController controlNombre = TextEditingController(text: nombrecli);
